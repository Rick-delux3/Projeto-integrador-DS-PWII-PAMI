    ...
    <?php
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if (!empty($_FILES['thumb']['name'])) {
                ...
                $caminho_fisico = __DIR__ . "/../front_end/assets/imagens/" . $nome_arquivo;
                $caminho_publico = "/Projeto-integrador-DS-PWII-PAMI/front_end/assets/imagens/" . $nome_arquivo;

                move_uploaded_file($_FILES["thumb"]["tmp_name"], $caminho_fisico);

                $thumb = $caminho_publico;
            } else {
                $thumb = "/../front_end/assets/imagens/default_image.png"; // imagem padrão
            }
